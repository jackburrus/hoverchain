  ...
  },
  {
    actions: {
      ...
      readyRequestButton: assign({
        ...
        selectedTextNodeRect: (context, event) => event.data.selectedNodeRect ?? context.selectedTextNodeRect,
      ...
      addInitialResponseChat: assign({
        chats: (context, event) => console.log(event.data, 'event.data', 'context', context),
